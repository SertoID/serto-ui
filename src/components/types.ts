...
export const dummyData = [
  {
    ...
    title: "A stunning 1 in 100 New York residents have now tested positive for coronavirus",
    ...
    slug: "stunning-1-100-new-york-residents-have-now-tested-positive-coronavirus",
    description:
      "The concentrations of cases in New York City, and New York State, appears unmatched across the globe.",
    contributors: [{ contributor: "Chris Mooney" }, { contributor: "Ben Guarino" }],
    images: [
      {
        url:
          "https://www.washingtonpost.com/wp-apps/imrs.php?src=https://arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/XQXEQXT3KII6VIYRVWYTIRYZVE.jpg&w=1440",
      },
    ],
    tags: [{ tag: "Health" }],
    primaryTag: "",
  ...
  },
  {
    ...
    title: "Where Germany had success in fighting coronavirus, Britain stumbled",
    publisher: "Washington Post",
    revisionContentHash: "",
    revisionContentURL: "",
    canonicalURL:
    ...
    images: [
      {
        url:
          "https://www.washingtonpost.com/wp-apps/imrs.php?src=https://arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/RCSZHQDY3QI6VIYRVWYTIRYZVE.jpg&w=1440",
      },
    ],
    tags: [{ tag: "Health" }],
    primaryTag: "",
  ...
  },
  {
    ...
    title: "Keep parks open. The benefits of fresh air outweigh the risks of infection.",
    publisher: "Washington Post",
    revisionContentHash: "",
    revisionContentURL: "",
    canonicalURL:
    ...
    description: "Some simple strategies can help keep you healthy. Remember to wear a mask.",
    contributors: [{ contributor: "Ishaan Tharoor" }],
    images: [
      {
        url:
  ...
  },
  {
    ...
    revisionContentHash: "",
    revisionContentURL: "",
    canonicalURL: "https://www.washingtonpost.com/education/2020/04/13/schools-reopen-coronavirus/",
